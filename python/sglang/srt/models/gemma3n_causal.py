...
class Gemma3nAltUp(nn.Module):
    ...
    def scale_corrected_output(self, corrected: torch.Tensor) -> torch.Tensor:
        ...
        return corrected * self.correct_output_scale.to(torch.bfloat16)
...
class Gemma3nAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # TODO: Currently, there are redundant computations for k and v in kv_shared_layer that should be avoided.
