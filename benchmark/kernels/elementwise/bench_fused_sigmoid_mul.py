...
The auto-dispatch path uses the per-head Triton kernel for small batch and a
wider hidden-block Triton kernel for large Qwen3.5 MoE attention gates.
...
@triton.testing.perf_report(
    triton.testing.Benchmark(
        x_names=["num_tokens"],
        x_vals=[1, 2, 4, 8, 16, 64, 128, 1024, 2048, 4096, 8192],
        line_arg="impl",
